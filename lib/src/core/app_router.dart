...
import 'package:connect/src/presentation/pages/connection_handler_page.dart';
import 'package:connect/src/presentation/pages/edit_profile_page.dart';
import 'package:connect/src/presentation/pages/forgot_password_page.dart';
import 'package:connect/src/presentation/pages/home_page.dart';
import 'package:connect/src/presentation/pages/login_page.dart';
import 'package:connect/src/presentation/pages/signup_page.dart';
import 'package:connect/src/presentation/pages/qr_code_page.dart';
import 'package:connect/src/presentation/pages/view_profile_page.dart';
// NEW: Import all the new pages
import 'package:connect/src/presentation/pages/scan_page.dart';
import 'package:connect/src/presentation/pages/connection_requests_page.dart';
import 'package:connect/src/presentation/pages/my_connections_page.dart';
import 'package:connect/src/presentation/pages/connection_detail_page.dart';
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      final isGoingToAuthPage = state.matchedLocation == '/login' ||
