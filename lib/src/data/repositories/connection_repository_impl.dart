...
import 'package:connect/src/data/repositories/connection_exceptions.dart';
...
class ConnectionRepositoryImpl implements ConnectionRepository {
  ...
  Future<void> createConnectionRequest({
    ...
    try {
      final request = ConnectionRequest(
        id: '',
        fromUserId: currentUserId, // THIS IS NOW CORRECT
      ...
      final docRef =
      await _firestore.collection(_requestsCollection).add(request.toJson());
  ...
  // THIS IS NOW THE CORRECT FINAL VERSION
  @override
